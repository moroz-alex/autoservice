...
@section('title', 'МойАвтосервис : Регистрация нового пользователя')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">Имя <span class="text-danger">*</span></label>
